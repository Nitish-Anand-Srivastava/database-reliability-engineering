...
Write-Output "Recommended Windows schedule for oracle:"
...
if ($Install) {
        ...
        Register-ScheduledTask -TaskName "CPF-oracle-OneOff" -Action $action1 -Trigger $trigger1 -Description "CPF one-off report every 30 minutes" -Force | Out-Null
        ...
        Register-ScheduledTask -TaskName "CPF-oracle-Cleanup" -Action $action2 -Trigger $trigger2 -Description "CPF retention cleanup" -Force | Out-Null
