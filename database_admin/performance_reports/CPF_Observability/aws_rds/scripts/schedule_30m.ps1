...
Write-Output "Recommended Windows schedule for aws_rds:"
...
if ($Install) {
        ...
        Register-ScheduledTask -TaskName "CPF-aws_rds-OneOff" -Action $action1 -Trigger $trigger1 -Description "CPF one-off report every 30 minutes" -Force | Out-Null
        ...
        Register-ScheduledTask -TaskName "CPF-aws_rds-Cleanup" -Action $action2 -Trigger $trigger2 -Description "CPF retention cleanup" -Force | Out-Null
