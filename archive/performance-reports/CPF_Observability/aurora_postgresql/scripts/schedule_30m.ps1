...
Write-Output "Recommended Windows schedule for aurora_postgresql:"
...
if ($Install) {
        ...
        Register-ScheduledTask -TaskName "CPF-aurora_postgresql-OneOff" -Action $action1 -Trigger $trigger1 -Description "CPF one-off report every 30 minutes" -Force | Out-Null
        ...
        Register-ScheduledTask -TaskName "CPF-aurora_postgresql-Cleanup" -Action $action2 -Trigger $trigger2 -Description "CPF retention cleanup" -Force | Out-Null
