...
Write-Output "Recommended Windows schedule for azure_sql_db:"
...
if ($Install) {
        ...
        Register-ScheduledTask -TaskName "CPF-azure_sql_db-OneOff" -Action $action1 -Trigger $trigger1 -Description "CPF one-off report every 30 minutes" -Force | Out-Null
        ...
        Register-ScheduledTask -TaskName "CPF-azure_sql_db-Cleanup" -Action $action2 -Trigger $trigger2 -Description "CPF retention cleanup" -Force | Out-Null
